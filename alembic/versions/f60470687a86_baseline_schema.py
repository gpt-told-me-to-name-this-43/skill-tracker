...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_experience_logs_skill_id'), 'experience_logs', ['skill_id'], unique=False)
    op.create_index(op.f('ix_experience_logs_user_id'), 'experience_logs', ['user_id'], unique=False)
